...
class iworks_international_5o5_pl_rankomat extends iworks_international_5o5_pl_rankomat_base {
	...
	public function __construct() {
		...
		$this->capability = apply_filters( 'iworks_international_5o5_pl_rankomat_capability', 'manage_options' );
		/**
		 * admin init
		 */
	...
	public function admin_init() {
		iworks_international_5o5_pl_rankomat_options_init();
	...
	public function admin_enqueue_scripts() {
		...
		/**
		 * off on not international-5o5-pl-rankomat pages
		 */
		...
		$file    = plugins_url( $file, $this->base );
		wp_register_style( 'admin-international-5o5-pl-rankomat', $file, array( 'jquery-ui-datepicker', 'select2' ), $version );
		wp_enqueue_style( 'admin-international-5o5-pl-rankomat' );
		/**
		 * select2
		 */
		 ...
		 */
		$files = array(
			'international-5o5-pl-rankomat-admin' => sprintf( 'assets/scripts/admin/admin%s.js', $this->dev ),
		);
		if ( '' == $this->dev ) {
			$files = array(
				'international-5o5-pl-rankomat-admin-datepicker' => 'assets/scripts/admin/src/datepicker.js',
				'international-5o5-pl-rankomat-admin-select2'    => 'assets/scripts/admin/src/select2.js',
			);
		}
		$deps = array(
		...
		wp_localize_script(
			'international_5o5_pl_rankomat_admin',
			__CLASS__,
			apply_filters( 'wp_localize_script_international_5o5_pl_rankomat_admin', $data )
		);
	}
	...
	public function init() {
		if ( is_admin() ) {
			...
			$file = 'assets/styles/international_5o5_pl_rankomat' . $this->dev . '.css';
			wp_enqueue_style( 'international-5o5-pl-rankomat', plugins_url( $file, $this->base ), array(), $this->get_version( $file ) );
		}
	}
